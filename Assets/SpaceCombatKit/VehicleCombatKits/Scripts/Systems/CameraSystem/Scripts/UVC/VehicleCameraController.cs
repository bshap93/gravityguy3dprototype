...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class VehicleCameraController : CameraController
    {
        ...
        [Tooltip("The vehicle classes that this camera controller is compatible with.")] [SerializeField]
        protected List<VehicleClass> compatibleVehicleClasses = new List<VehicleClass>();

        [Header("Starting View")] [Tooltip("The starting view for the camera when it is initialized.")] [SerializeField]
        ...
        public void SetCamera(CameraEntity cameraEntity)
        {
            ...
            {
                Debug.LogError(
                    "Cannot use a Vehicle Camera Controller with the Camera Entity component. Must be used with Vehicle Camera instead.");
            }
        }
