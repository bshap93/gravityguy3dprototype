...
namespace VSX.UniversalVehicleCombat.Radar
{
    ...
    {
        [SerializeField] protected bool rotateMap = true;
        ...
        private void LateUpdate()
        {
            ...
            if (rotateMap) mapPivot.localRotation = Quaternion.Euler(0f, 0f, Quaternion.FromToRotation(minimapCamera.transform.up, playerVehicle.forward).eulerAngles.y);
        }
