    ...
    public struct TargetingControlsActions
    {
        ...
        public void SetCallbacks(ITargetingControlsActions instance)
        {
            if (m_Wrapper.m_TargetingControlsActionsCallbackInterface != null)
            {
                ...
                @TargetUnderCursor.started -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetUnderCursor;
                @TargetUnderCursor.performed -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetUnderCursor;
                @TargetUnderCursor.canceled -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetUnderCursor;
            }
