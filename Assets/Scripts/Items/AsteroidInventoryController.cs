...
public class FreeholdAsteroidBaseInventoryController : MonoBehaviour
{
    ...
    [FormerlySerializedAs("hotbarSlots")] public GameObject[] inventorySlots;
    public List<HotbarController.ItemObjective> ItemObjectives = new List<HotbarController.ItemObjective>();
    ...
    void Start()
    {
        ...
        QuestEntryDictionary.Add("Nitrogen Pellet", 5);
        QuestEntryDictionary.Add("3D Printer", 6);
    ...
    public void AddItemObjective(HotbarController.ItemObjective itemObjective)
    {
    ...
    public static void AddItemObjectiveWrapper(string itemName)
    {
        if (Instance != null)
        {
            ...
            HotbarController.ItemObjective itemObjective = new HotbarController.ItemObjective(runtimeID);
